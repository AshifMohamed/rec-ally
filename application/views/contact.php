<header class="site-header size-lg text-center innerpage" style="background-image: url(<?php echo base_url('assets/img/front/img/contact-banner.png'); ?>)">

</header>
<div class="container contact-inner">
    <h2>Contact Us</h2>
    <div class="col-md-7 col-sm-7 contact-body left-padding clearfix">						
    ...
    <div class="col-md-5 col-sm-5 contact-follow-us">
        <h5>Follow us</h5> 
        <ul  class="cnt-social">
            <li><a href="https://www.facebook.com/webnetally" target="_blank"><img class="img-responsive" src="<?=base_url('assets/img/front/img')?>/fb-icn.png"></a></li>
            <li><a href="https://twitter.com/amjeddmour" target="_blank"><img class="img-responsive" src="<?=base_url('assets/img/front/img')?>/twt-icn.png"></a></li>
            <li><a href="https://www.linkedin.com/company/webnet-ally?trk=top_nav_home" target="_blank"><img class="img-responsive" src="<?=base_url('assets/img/front/img')?>/in-icn.png"></a></li>
            <li><a href="https://www.youtube.com/watch?v=jFc1Ms0m4fI&ab_channel=MohamedWazil"  target="_blank"><img class="img-responsive" src="<?=base_url('assets/img/front/img')?>/yt-icn.png"></a></li>
        </ul>	
        ...
        <div id="contact_form"class="contact-form  wow fadeInDown">
            <form method="POST" name="contact_us_form" class="form-horizontal" action="<?=base_url()?>submit_contact_us">
                <div class="well">
