    ...
    <header class="page-header bg-img size-lg" style="background-image: url(<?php echo base_url(); ?>assets/img/bg-banner1.jpg)">
      <div class="container">
        <div class="header-detail">
          <img class="logo" src="<?php echo base_url(); ?>assets/img/logo-google.jpg" alt="">
          <div class="hgroup">
		  ...
		  <table class="table jb-description-table">
			<tbody>
			  ...
			  <tr>
				<td>Vacancy </td>
				<td>Code159jopcleantech20171117</td>
			  </tr>
			  <tr>
				<td>Company Industry </td>
				<td>Telecommunication, Contracting , Data Center Facility Infrastructure</td>
			  </tr>
			  <tr>
				<td>Job Families </td>
				<td>Engineering</td>
			  ...
			  <tr>
				...
				<td>Working experience with minimum 3 years</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<td>Mobility</td>
				<td>Must be traveled outside the city</td>
			  </tr>
			  <tr>
